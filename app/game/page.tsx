...
export default function FactorizationGame() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-indigo-500/30">
      {/* Game-level connection badge bar */}
      <div className="max-w-5xl mx-auto w-full px-4 pt-4 flex items-center justify-between gap-3">
      ...
      {!isSupabaseConfigured && (
        <div className="bg-gradient-to-r from-amber-600/20 to-orange-600/20 border-b border-amber-600/30 text-amber-300 text-xs px-4 py-2.5 text-center font-medium mt-3">
